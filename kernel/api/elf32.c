                       ...
                       char *const envp[], uint32_t *eip, uint32_t *esp)
{
        ...
        if (0 > (err = _elf32_load_ehdr(fd, &header, 0))) {
        	dbg_print("\n\n\n\n\n\n\n\n\......Load and verify the ELF header ......err=%d........\n\n\n\n\n\n\n\n\n",err);
                goto done;
        }
        ...
        if (0 > (err = _elf32_find_phinterp(&header, pht, &phinterp))) {
        	dbg_print("\n\n\n\n\n\n\n\n\......eck if program requires an  ......err=%d........\n\n\n\n\n\n\n\n\n",err);
                goto done;
        }
